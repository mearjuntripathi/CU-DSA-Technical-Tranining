...
You may not alter the values in the list's nodes, only nodes themselves may be changed. and return the reversed list.


Example 1:
```
Input: head = [1,2,3,4,5], left = 2, right = 4 , k=2
Output: [1,3,2,4,5]
```

Example 2:
```
Input: head = [5], left = 1, right = 1,k=4
Output: [5]
```
